...
def build_arg_parser():
    p = argparse.ArgumentParser(description="Sweep Toto horizons.")
    ...
    p.add_argument("--feature_cols", type=str, default=None, help="Comma-separated feature columns.")
    return p
...
def sweep(params: argparse.Namespace) -> pd.DataFrame:
    ...
    print("[sweep] feature_cols =", params.feature_cols)
    ...
    for idx, horizon in enumerate(combos, 1):
        run_name = f"ctx{params.context_length}_h{horizon}"
